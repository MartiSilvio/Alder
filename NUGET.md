...
Benchmarks for the parser, binder, interpreter, compiled backend, and Dynamic LINQ live under [`benchmarks/Alder.Benchmarks`](https://github.com/MartiSilvio/Alder/blob/master/benchmarks/Alder.Benchmarks). Run them locally to compare against your workload:
...
Full documentation lives in [`docs/`](https://github.com/MartiSilvio/Alder/blob/master/docs/README.md), organized as concepts, guides, reference, and operations.
...
Repository layout, test-suite organization, and the AOT-matrix harness are in [CONTRIBUTING.md](https://github.com/MartiSilvio/Alder/blob/master/CONTRIBUTING.md).
