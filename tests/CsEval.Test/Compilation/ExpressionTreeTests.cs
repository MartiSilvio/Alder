...
public class ExpressionTreeTests
{
    ...
    {
        var extendedEngine = new CsEvalEngine(CsEvalOptions.Default with
        {
    ...
    public void ParseAsExpression_UnsupportedBlock_ThrowsCsEvalException()
    {
        ...
        Assert.That(ex!.ErrorCode, Is.EqualTo(CsEval.Diagnostics.DiagnosticCode.CSEV0002));
    ...
    public void TryParse_UnsupportedNamedArgument_ReturnsSpecificDiagnosticWithCode()
    {
        ...
        Assert.That(result, Is.Null);
        Assert.That(diagnostics, Has.Count.GreaterThan(0));
        Assert.That(diagnostics[0].Code, Is.EqualTo(CsEval.Diagnostics.DiagnosticCode.CSEV0003));
    ...
    public void ExpressionTree_NoOpaqueRuntimeHelperCalls()
    {
        ...
        // -- no calls to CsEval runtime helpers
    ...
    /// <summary>
    /// Expression visitor that detects calls to opaque CsEval runtime helpers.
    ...
    private class OpaqueCallDetector : ExpressionVisitor
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression node)
        {
            ...
            if (declaringType != null)
            {
                ...
                if (ns.StartsWith("CsEval", StringComparison.Ordinal))
                {
