...
public class CSharp12FeatureInventoryTests
{
    ...
    // Out of scope for a runtime engine -- class declarations are not expressions.
    ...
    // 5. Inline Arrays
    // Requires struct declaration with [InlineArray] attribute -- out of scope for runtime engine.
    ...
    // Requires using directive -- out of scope for runtime engine.
