// All tests engine-only: exercise internal TypeResolver API through AlderEngine.Evaluate
...
///
/// TypeResolver is internal, so all tests exercise it through the public AlderEngine API.
...
public class TypeResolverTests(CompilationMode mode)
{
    ...
    [Test]
    public void ResolveType_RegisterNamespace_SystemNamespace_MathCeil()
    {
    ...
    [Test]
    public void ResolveType_RegisterNamespace_SystemNamespace_ConvertToInt()
    {
        var engine = CreateEngine();
    ...
    {
        // FQN works without RegisterNamespace
        var engine = CreateEngine();
    ...
    [Test]
    public void ResolveType_FullyQualified_NotFound_ThrowsAlderException()
    {
        var engine = CreateEngine();
