// Engine-only: Switch statement tests with error assertions, SetVariable, Alder-specific syntax
...
public class SwitchStatementTests(CompilationMode mode)
{
    ...
    public void NonEmptyCase_WithoutBreak_ThrowsError()
    {
        ...
        Assert.That(() => engine.Evaluate("""
            ...
            """),
            Throws.TypeOf<AlderException>().With.Message.Contains("CS0163"));
    }
    ...
    // Engine-only: tests Alder parsing internals (TryParse)
    [Test]
