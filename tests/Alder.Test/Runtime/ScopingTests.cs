// Engine-only: All tests verify variable scoping via error assertions (AlderException for leaked variables)
// or use Alder-specific [1,2,3] collection expression and [..spread] syntax
...
public class ScopingTests(CompilationMode mode)
{
    ...
    // Engine-only: error tests and Alder-specific [1,2,3] syntax
    [Test]
