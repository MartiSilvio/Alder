...
CsEval uses two error code namespaces:

- **CS####** (35 codes) -- Roslyn-parity codes that match C# compiler error numbers
- **CSEV####** (49 codes) -- CsEval-specific codes with no Roslyn equivalent
...
Error codes appear in `CsEvalException.FormattedCode`, `CsEvalException.ErrorCode`, and `CsEvalDiagnostic.Code`.
