...
internal static class ContextEmitter
{
    public static string Emit(ContextModel context)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"{indent}    private static readonly global::CsEval.IAotTypeMetadata[] s_metadata =");
        sb.AppendLine($"{indent}    [");
        ...
        sb.AppendLine($"{indent}    ];");
        sb.AppendLine();
        sb.AppendLine($"{indent}    public override global::System.Collections.Generic.IReadOnlyList<global::CsEval.IAotTypeMetadata> GetTypeMetadata() => s_metadata;");
        sb.AppendLine($"{indent}}}");
