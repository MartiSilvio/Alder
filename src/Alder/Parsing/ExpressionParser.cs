...
internal sealed partial class ExpressionParser : ParserBase
{
    ...
    private Expr ParsePipeline()
    {
        ...
        {
            throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.PipeGreater));
        }
    ...
    private Expr ParseEquality()
    {
                   ...
                   TokenType.EqualEqualEqual, TokenType.BangEqualEqual))
        {
            ...
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(op.Type));
            }
    ...
    private Expr ParseComparison()
    {
        ...
        while (true)
        {
            ...
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.In));
            }
            else if (State.LanguageMode == LanguageMode.Standard && Check(TokenType.Like))
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.Like));
            }
            ...
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.EqualTilde));
            }
            else if (State.LanguageMode == LanguageMode.Standard
                     && Check(TokenType.BangTilde))
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.BangTilde));
            }
            else if (State.LanguageMode == LanguageMode.Standard
                     && Check(TokenType.LessEqualGreater))
            {
                throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.LessEqualGreater));
            }
            else
            {
                break;
    ...
    private Expr ParsePower()
    {
        ...
        {
            throw new AlderException(DiagnosticDescriptors.ExtendedModeRequired,TokenLexemes.GetCanonical(TokenType.StarStar));
        }
