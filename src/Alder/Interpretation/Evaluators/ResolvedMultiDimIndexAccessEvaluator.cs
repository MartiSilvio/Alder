...
internal sealed class ResolvedMultiDimIndexAccessEvaluator : INodeEvaluator<BoundResolvedMultiDimIndexAccessExpr>
{
    public object? Evaluate(BoundResolvedMultiDimIndexAccessExpr node, EvaluationContext ctx)
    {
