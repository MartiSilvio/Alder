...
internal sealed class MultiDimIndexAssignEvaluator : INodeEvaluator<BoundMultiDimIndexAssignExpr>
{
    public object? Evaluate(BoundMultiDimIndexAssignExpr node, EvaluationContext ctx)
    {
