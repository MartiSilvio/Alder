...
internal static class ChainedComparisonHelper
{
    ...
    /// </summary>
    public static bool PerformComparison(object? left, object? right, TokenType opType, AlderOptions options)
    {
    ...
    /// </summary>
    public static object EvaluateChain(object?[] operands, int[] operatorTypes, AlderOptions options)
    {
