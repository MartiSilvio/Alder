...
internal sealed class MemberCompoundAssignBinder : INodeBinder<MemberCompoundAssignExpr>
{
    public BoundExpr Bind(MemberCompoundAssignExpr expr, BindingContext context, BinderContext binder)
    {
