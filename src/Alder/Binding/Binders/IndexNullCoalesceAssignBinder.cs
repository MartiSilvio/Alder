...
internal sealed class IndexNullCoalesceAssignBinder : INodeBinder<IndexNullCoalesceAssignExpr>
{
    public BoundExpr Bind(IndexNullCoalesceAssignExpr expr, BindingContext context, BinderContext binder)
    {
