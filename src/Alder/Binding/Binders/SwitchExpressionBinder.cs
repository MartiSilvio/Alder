...
internal sealed class SwitchExpressionBinder : INodeBinder<SwitchExpressionExpr>
{
    public BoundExpr Bind(SwitchExpressionExpr expr, BindingContext context, BinderContext binder)
    {
