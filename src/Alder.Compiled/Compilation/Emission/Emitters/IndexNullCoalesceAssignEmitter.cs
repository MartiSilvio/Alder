...
[EmitsNode(BoundNodeKind.IndexNullCoalesceAssignment)]
internal static class IndexNullCoalesceAssignEmitter
{
    public static LinqExpression Emit(BoundIndexNullCoalesceAssignExpr node, EmissionContext ctx)
    {
