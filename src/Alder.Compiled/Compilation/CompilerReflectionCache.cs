...
internal static readonly MethodInfo SpreadIntoDictMethod = typeof(CollectionFactory).GetMethod(nameof(CollectionFactory.SpreadIntoDict))!;
internal static readonly MethodInfo SpreadIntoListMethod = typeof(CollectionFactory).GetMethod(nameof(CollectionFactory.SpreadIntoList))!;
internal static readonly MethodInfo InferAndCreateArrayMethod = typeof(RuntimeArrayFactory).GetMethod(nameof(RuntimeArrayFactory.InferAndCreateArray))!;
