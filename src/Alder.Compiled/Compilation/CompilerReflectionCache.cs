...
internal static class CompilerReflectionCache
{
    ...
    internal static readonly MethodInfo SetMethod =
        typeof(AlderContext).GetMethod("Set", [typeof(string), typeof(object)])!;

    internal static readonly MethodInfo DefineMethod =
        typeof(AlderContext).GetMethod("Define", [typeof(string), typeof(object)])!;

    internal static readonly MethodInfo DefineWithTypeMethod =
        typeof(AlderContext).GetMethod("Define", [typeof(string), typeof(object), typeof(Type)])!;

    internal static readonly MethodInfo DefineNewMethod =
        typeof(AlderContext).GetMethod("DefineNew", [typeof(string), typeof(object), typeof(Type)])!;

    internal static readonly MethodInfo
        TryGetVariableTypeMethod = typeof(AlderContext).GetMethod("TryGetVariableType")!;
    ...
    internal static readonly MethodInfo GetTypeResolverProperty =
        typeof(AlderContext).GetProperty(nameof(AlderContext.TypeResolver),
    ...
    internal static readonly MethodInfo InvokeConstructorMethod =
        typeof(ConstructionRuntime).GetMethod(nameof(ConstructionRuntime.InvokeConstructor),
            [typeof(Type), typeof(object?[]), typeof(AlderConfig)])!;
    ...
    internal static readonly MethodInfo GetDefaultValueMethod =
        typeof(TypeHelpers).GetMethod(nameof(TypeHelpers.GetDefaultValue), [typeof(Type)])!;

    internal static readonly MethodInfo IsNullableTypeMethod =
        typeof(TypeHelpers).GetMethod(nameof(TypeHelpers.IsNullableType))!;
    ...
    internal static readonly MethodInfo GetSliceStepMethod =
        typeof(MemberAccess).GetMethod(nameof(MemberAccess.GetSlice),
    ...
    internal static readonly MethodInfo ListAddRangeMethod =
        typeof(List<object?>).GetMethod(nameof(List<object?>.AddRange))!;
    ...
    internal static readonly MethodInfo ThrowIfCancellationRequestedMethod =
    ...
    internal static readonly MethodInfo GetConstraintsProperty =
        typeof(AlderConfig).GetProperty(nameof(AlderConfig.Constraints))!.GetGetMethod()!;
    ...
    internal static readonly MethodInfo GetCurrentProperty =
    ...
    internal static readonly MethodInfo ValidateCompoundAssignmentMethod =
        typeof(AssignmentRuntime).GetMethod(nameof(AssignmentRuntime.ValidateCompoundAssignment))!;
    ...
    internal static readonly MethodInfo ExplicitCastMethod =
        typeof(TypeHelpers).GetMethod(nameof(TypeHelpers.ExplicitCast),
            [typeof(object), typeof(Type), typeof(Type), typeof(bool)])!;

    internal static readonly MethodInfo IsTypeMethod =
    ...
    internal static readonly MethodInfo GuardReflectionLeakMethod =
        typeof(TypeHelpers).GetMethod(nameof(TypeHelpers.GuardReflectionLeak), [typeof(object), typeof(string)])!;
    ...
    internal static readonly MethodInfo ResolveIdentifierTypedMethod =
        typeof(IdentifierRuntime).GetMethod(nameof(IdentifierRuntime.ResolveIdentifierTyped))!;
    ...
    internal static readonly MethodInfo ConditionalTypePromotionMethod =
        typeof(ConstructionRuntime).GetMethod(nameof(ConstructionRuntime.ConditionalTypePromotion))!;
