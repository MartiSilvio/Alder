...
internal sealed partial class ILCompiler
{
    ...
    private static readonly MethodInfo ResolveTypeByNameMethod = typeof(TypeHelpers).GetMethod(nameof(TypeHelpers.ResolveTypeByName))!;
    private static readonly MethodInfo InvokeConstructorMethod = typeof(RuntimeHelpers).GetMethod(nameof(RuntimeHelpers.InvokeConstructor))!;
    private static readonly MethodInfo CreateTupleMethod = typeof(RuntimeHelpers).GetMethod(nameof(RuntimeHelpers.CreateTuple))!;
    private static readonly MethodInfo DeconstructTupleMethod = typeof(RuntimeHelpers).GetMethod(nameof(RuntimeHelpers.DeconstructTuple))!;
    ...
    private static readonly MethodInfo LogicalNotMethod = typeof(Operators).GetMethod(nameof(Operators.LogicalNot), [typeof(object)])!;
    ...
    private LinqExpression Compile(Expr expr)
    {
        ...
        try
        {
            return expr switch
            {
                ...
                TypeofExpr typeofExpr => CompileTypeof(typeofExpr),
                ObjectCreationExpr oc => CompileObjectCreation(oc),
                ...
                IsPatternExpr isExpr => CompileIsPattern(isExpr),
                AsExpr asExpr => CompileAs(asExpr),
                SwitchExpressionExpr se => CompileSwitchExpression(se),
