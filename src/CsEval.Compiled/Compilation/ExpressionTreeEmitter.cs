...
internal sealed class ExpressionTreeEmitter
{
    ...
    public LinqExpression Emit(BoundExpr expr)
    {
        return expr switch
        {
            ...
            BoundGotoExpr => throw UnsupportedNode("a goto statement"),
            BoundGotoCaseExpr => throw UnsupportedNode("a goto case statement"),
            BoundGotoDefaultExpr => throw UnsupportedNode("a goto default statement"),
            BoundLabelExpr => throw UnsupportedNode("a label"),
            ...
            BoundMultiDimArrayInitExpr => throw UnsupportedNode("multi-dimensional array creation"),
