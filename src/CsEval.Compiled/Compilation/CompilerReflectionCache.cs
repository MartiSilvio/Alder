...
internal static readonly MethodInfo InvokeConstructorMethod = typeof(ConstructionRuntime).GetMethod(nameof(ConstructionRuntime.InvokeConstructor), [typeof(Type), typeof(object?[]), typeof(CsEvalConfig), typeof(CsEvalOptions)])!;
...
internal static readonly MethodInfo CheckAllowAssignmentMethod = typeof(ExecutionRuntime).GetMethod(nameof(ExecutionRuntime.CheckAllowAssignment))!;
internal static readonly MethodInfo CheckAllowIndexSetMethod = typeof(AssignmentRuntime).GetMethod(nameof(AssignmentRuntime.CheckAllowIndexSet))!;
