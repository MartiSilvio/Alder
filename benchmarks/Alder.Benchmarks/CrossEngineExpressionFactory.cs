...
public enum CrossEngineExpressionDialect
{
    CSharp,
    Flee
}

public static class CrossEngineExpressionFactory
{
    public static string BuildBigBooleanStress(CrossEngineExpressionDialect dialect)
    {
        return dialect switch
        {
            CrossEngineExpressionDialect.CSharp => BuildBigBooleanStressCore("x", "y", "z", "value", "&&", "||", "!=", "=="),
            CrossEngineExpressionDialect.Flee => BuildBigBooleanStressCore("x", "y", "z", "value", "and", "or", "<>", "="),
